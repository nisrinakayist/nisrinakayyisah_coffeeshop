                                ...
                                <tbody>
                                    ...
                                    <div class="row align-items-center py-2 border-bottom border-secondary">
                                        ...
                                        <div class="col-1 text-secondary action-btn">
                                            ...
                                            <form action="{{ route('tokos.destroy',$toko->id) }}" method="POST" class="delete-form" data-nama="{{ $toko->nama_toko }}">
                                                @csrf
                                                @method('DELETE')
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('.delete-form').forEach(form => {
        ...
        form.addEventListener('submit', function(e) {
            ...
            const namaToko = form.dataset.nama;

            Swal.fire({
                title: 'Are you sure?',
                html: `<b>${namaToko}</b> akan terhapus permanen`,
